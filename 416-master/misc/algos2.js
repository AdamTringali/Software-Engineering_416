...
function calculate_Questionable_Acceptance_Decision(acceptanceDecision, userProfile)
{
...
function calculate_Questionable_Reject_Decision(acceptanceDecision, userProfile){
    return ( 1 - calculate_Questionable_Acceptance_Decision(acceptanceDecision, userProfile) )
}
...
function detect_Questionable_Decision(acceptanceDecision, userProfile){
    ...
    if(status == 'ACCEPTED')
    {
        score = calculate_Questionable_Acceptance_Decision(acceptanceDecision, userProfile)
    }
    if(status == 'REJECTED')
    {
        score = calculate_Questionable_Reject_Decision(acceptanceDecision, userProfile)
    }
    if (score > 0.75)
        return false
    return true
...
function testQuestionableDecisions() {
    ...
    console.log("Testing qusetionable acceptance decision - Lower Averages (Questionable decisions)")
    console.log(detect_Questionable_Decision(sampleAcceptanceDecision, sampleUserProfile3))
    console.log("Testing qusetionable acceptance decision - Higher Averages (Not Questionable decisions)")
    console.log(detect_Questionable_Decision(sampleAcceptanceDecision, sampleUserProfile2))

    console.log("Testing qusetionable reject decision - Lower Averages (Not Questionable decisions)")
    console.log(detect_Questionable_Decision(sampleRejectDecision, sampleUserProfile3))
    console.log("Testing qusetionable reject decision - Higher Averages (Questionable decisions)")
    console.log(detect_Questionable_Decision(sampleRejectDecision, sampleUserProfile2))
