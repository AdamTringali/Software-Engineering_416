...
import { Row, Container, Col, Form, Tabs, Tab, Card, Modal, Button } from 'react-bootstrap';
...
export default function ProfileModal(props) {
    ...
    useEffect(() => {
        async function getProfile() {
            try {
                const res_data = await axios.get(`${Constants.port}/students/${props.userid}`);
                            ...
                            <Col>
                                ...
                                <Form>
                                    ...
                                    <Form.Group as={Row} bsPrefix="profileItem" >
                                        ...
                                        <Col sm={5}> <Form.Control disabled={true} value={studentInfo.high_school_name} /> </Col>
                                    </Form.Group>
                                    <Form.Group as={Row} bsPrefix="profileItem"  >
                                        <Form.Label column sm={4}> High School City </Form.Label>
                                        <Col sm={4}> <Form.Control disabled={true} value={studentInfo.high_school_city}  /> </Col>
                                    </Form.Group>
                                    <Form.Group as={Row} bsPrefix="profileItem" >
                                        <Form.Label column sm={4}> High School State </Form.Label>
                                        <Col sm={4}> <Form.Control  disabled={true} value={studentInfo.high_school_state} /> </Col>
                                    </Form.Group>
                                    <Form.Group as={Row} bsPrefix="profileItem" >
                                        <Form.Label column sm={4}> Graduation Year </Form.Label>
                                        <Col sm={4}> <Form.Control  disabled={true} value={studentInfo.college_class} /> </Col>
                                    </Form.Group>
                                    <Form.Group as={Row} bsPrefix="profileItem" >
                                        <Form.Label column sm={4}> Major 1 </Form.Label>
                                        <Col sm={4}> <Form.Control  disabled={true} value={studentInfo.major_1} /> </Col>
                                    </Form.Group>
                                    <Form.Group as={Row} bsPrefix="profileItem" > <Form.Label column sm={4}> Major 2 </Form.Label>
                                        <Col sm={4}> <Form.Control  disabled={true} value={studentInfo.major_2} /> </Col>
                                    </Form.Group>
                                    <Form.Group as={Row} bsPrefix="profileItem" >
                                        <Form.Label column sm={4}> #AP Passed </Form.Label>
                                        <Col sm={4}> <Form.Control disabled={true} value={studentInfo.num_AP_passed} /> </Col>
                                    </Form.Group>
                                    <Form.Group as={Row} bsPrefix="profileItem" >
                                        <Form.Label column sm={4}> GPA </Form.Label>
                                        <Col sm={4}> <Form.Control disabled={true} value={studentInfo.gpa} /> </Col>
                                    </Form.Group>
                                </Form>
                            </Col>
                            <Col>
                                ...
                                <Tabs defaultActiveKey="sat" id="uncontrolled-tab-example">
                                    <Tab eventKey="sat" title="SAT">
                                        ...
                                        <Form.Group as={Row} bsPrefix="profileItem" >
                                            ...
                                            <Col sm={2}><Form.Control  disabled={true} value={studentInfo.SAT_EBRW} /></Col>
                                            <Form.Label column sm={3} > US History </Form.Label>
                                            <Col sm={2}><Form.Control  disabled={true} value={studentInfo.SAT_US_hist} /></Col>

                                        </Form.Group>
                                        <Form.Group as={Row} bsPrefix="profileItem" >
                                            <Form.Label column sm={3}> Math </Form.Label>
                                            <Col sm={2}><Form.Control disabled={true} value={studentInfo.SAT_math} /></Col>
                                            <Form.Label column sm={3}> World History </Form.Label>
                                            <Col sm={2}><Form.Control disabled={true} value={studentInfo.SAT_world_hist} /></Col>
                                        </Form.Group>
                                        <Form.Group as={Row} bsPrefix="profileItem" >
                                            <Form.Label column sm={3}> Math l </Form.Label>
                                            <Col sm={2}><Form.Control disabled={true} value={studentInfo.SAT_math_I} /></Col>
                                            <Form.Label column sm={3}> Bio Ecological </Form.Label>
                                            <Col sm={2}><Form.Control  disabled={true} value={studentInfo.SAT_eco_bio} /></Col>
                                        </Form.Group>
                                        <Form.Group as={Row} bsPrefix="profileItem" >
                                            <Form.Label column sm={3}> Math ll </Form.Label>
                                            <Col sm={2}><Form.Control  disabled={true} value={studentInfo.SAT_math_II} /></Col>
                                            <Form.Label column sm={3}> Bio Molecular </Form.Label>
                                            <Col sm={2}><Form.Control  disabled={true} value={studentInfo.SAT_mol_bio} /></Col>
                                        </Form.Group>
                                        <Form.Group as={Row} bsPrefix="profileItem" >
                                            <Form.Label column sm={3}> Chemistry </Form.Label>
                                            <Col sm={2}><Form.Control disabled={true} value={studentInfo.SAT_chemistry} /></Col>
                                        </Form.Group>
                                    </Tab>
                                    <Tab eventKey="act" title="ACT">
                                        ...
                                        <Form.Group as={Row} bsPrefix="profileItem" >
                                            ...
                                            <Col sm={2}><Form.Control disabled={true} value={studentInfo.ACT_English} /></Col>
                                            <Form.Label column sm={3}> Reading </Form.Label>
                                            <Col sm={2}><Form.Control  disabled={true} value={studentInfo.ACT_reading} /></Col>
                                        </Form.Group>
                                        <Form.Group as={Row} bsPrefix="profileItem" >
                                            <Form.Label column sm={3}> Science </Form.Label>
                                            <Col sm={2}><Form.Control disabled={true} value={studentInfo.ACT_science} /></Col>
                                            <Form.Label column sm={3}> Composite </Form.Label>
                                            <Col sm={2}><Form.Control  disabled={true} value={studentInfo.ACT_composite} /></Col>
                                        </Form.Group>
                                        <Form.Group as={Row} bsPrefix="profileItem" >
                                            <Form.Label column sm={3}> Math </Form.Label>
                                            <Col sm={2}><Form.Control disabled={true} value={studentInfo.ACT_math} /></Col>
                                        </Form.Group>
                                    </Tab>
                                </Tabs>
                                <Row >
